        ...
        <div className="wrap">
          ...
          <div style={{ maxWidth: 640, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 15, color: 'var(--whisk)', marginBottom: 8 }}>
              About five minutes. Your name, email, resume and a link to something you&apos;ve made are the
              required fields — the rest helps, but a blank box won&apos;t cost you the role.
            </p>
